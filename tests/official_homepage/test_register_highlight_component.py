...
def test_register_highlight_component(load_env,page:Page):
    ...
    register_feature_component1=register_Mod_component(page)
    ...
    register_feature_component1.register_feature_component(common_locator1.Highlight_title,"0",common_locator1.EN_highlight_title)
    common_function1.verify_register_successful(common_locator1,"Highlight Mod")
