...
def test_register_banner_successful(load_env,page):
    ...
    register_banner_page1.register_hero_banner_component(common_locator.Hero_banner_title,"0","0","https://jira.smilegate.net/browse/BBZG-3725")
    ...
    common_functions.verify_register_successful(common_locator,"Hero Banner")
    main_display_page1.open_mainpage(load_env)
    common_functions.verify_banner_display(common_locator,"Hero Banner")
